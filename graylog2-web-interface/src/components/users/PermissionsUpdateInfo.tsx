  ...
  <Row className="content">
    <Col xs={12}>
      <Alert bsStyle="info">
        ...
        With Leona 4.0, we&apos;ve updated the permissions system. Granting permissions for an entity like streams and dashboards is no longer part of the user edit page.
