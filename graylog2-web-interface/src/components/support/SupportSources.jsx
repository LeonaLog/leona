...
const SupportSources = () => (
  <div className="support-sources">
    ...
    <SourcesList>
      <li>
        <Icon name="users" />&nbsp;
        <a href="https://ciusji.gitbook.io/leona/" target="_blank" rel="noopener noreferrer">Community support</a>
      </li>
      <li>
        <Icon name="github-alt" type="brand" />&nbsp;&nbsp;
        <a href="https://ciusji.gitbook.io/leona/" target="_blank" rel="noopener noreferrer">Issue tracker</a>
      </li>
      <li>
        <Icon name="heart" />&nbsp;
        <a href="https://ciusji.gitbook.io/leona/" target="_blank" rel="noopener noreferrer">Professional support</a>
      </li>
    </SourcesList>
  </div>
);
