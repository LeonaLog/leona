...
const NoWidgetsInfo = () => (
  <StyledJumbotron>
    ...
    <ul>
      ...
      <IfDashboard>
        <li><p>4. <b>Share</b> the dashboard with your colleagues. Prepare it for <b>reuse</b> by using parameters (contained in <a href="https://ciusji.gitbook.io/leona/" target="_blank" rel="noopener noreferrer">Leona Enterprise</a>).</p></li>
      </IfDashboard>
    </ul>
    <p>
